      ...
      >
        ...
        <div className="flex-1 md:ml-16 md:mr-8 flex flex-col justify-center mb-8 lg:mb-0">
          ...
          <p className="relative z-10 [text-shadow:0px_0px_6.9px_#00000066] [font-family:'Roboto',Helvetica] font-light text-[#cbd5e0] text-base md:text-lg lg:text-[20px] tracking-[0] leading-[24px] md:leading-[28px] mb-6 md:mb-[40px] max-w-[700px] text-center lg:text-left">
            At the Law Offices of Ariadne Berrios, LLC, attorney Ariadne Berrios combines vast federal immigration experience with a compassionate, bilingual approach to help families, professionals, and businesses achieve their immigration goals. With offices in Las Vegas Metropolitan Area, as well as San Juan, Puerto Rico, the firm proudly serves clients nationwide with integrity, care, and results-driven advocacy.
          </p>
