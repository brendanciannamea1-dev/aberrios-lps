...
export const ContactForm = (): JSX.Element => {
  ...
  // Get comprehensive tracking parameters for Basin
  const getTrackingParams = () => {
    ...
    return {
      ...
      msclkid: urlParams.get('msclkid') || '', // Microsoft Ads click ID
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        form_location: 'Las Vegas - English',
      };
  ...
  return (
    <Card className="w-full max-w-md lg:max-w-none bg-black/90 border-[#b89158] border-2 backdrop-blur-sm">
      ...
      <CardContent>
        <form name="las-vegas-immigration-lp-english" onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
          <div>
            <input
              type="text"
              name="name"
