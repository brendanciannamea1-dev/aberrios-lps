              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="[font-family:'Roboto',Helvetica] font-semibold text-white text-sm md:text-base mb-1">
                    Las Vegas Office Phone Number
                  </p>
                  <a href="tel:+17023444133" className="[font-family:'Roboto',Helvetica] font-semibold text-white text-base md:text-lg hover:text-[#C89141] transition-colors block mb-1">
                    (702) 344-4133
                  </a>
