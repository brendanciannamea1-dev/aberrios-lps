      ...
      <div className="container mx-auto px-4 md:px-12">
        ...
        <div className="text-center mt-8 md:mt-12">
          <p className="[font-family:'Roboto',Helvetica] font-light text-[#666666] text-base md:text-lg mb-6">
            At the Law Offices of Ariadne Berrios, we believe immigration help should be accessible, ethical, and empowering. Contact us today to schedule your consultation and take the next step toward achieving your immigration goals.
          </p>
          <a
