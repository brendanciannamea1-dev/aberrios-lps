...
const services = [
  ...
  "Visa P (para deportistas)",
  "Visa O (para deportistas y/o artistas)",
  ...
  return (
    <section className="relative w-full min-h-[600px]">
        ...
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="w-full md:w-[521px] h-auto md:h-[83px] bg-[#450B0A] flex justify-center md:justify-end">
            <div className="w-full md:w-[521px] h-auto md:h-[83px] bg-[#450B0A] flex flex-col justify-center items-center py-4 md:py-0">
              <a href="tel:+19393603000" className="[font-family:'Poppins',Helvetica] font-extrabold text-white text-lg md:text-[21px] text-center tracking-[1.00px] md:tracking-[2.00px] leading-[20px] md:leading-[23.1px] hover:text-gray-200 transition-colors">
                (939) 360-3000
              </a>
              <div className="[font-family:'Roboto',Helvetica] font-medium text-white text-[10px] md:text-[11px] text-center tracking-[2.00px] md:tracking-[4.00px] leading-[16px] md:leading-[19.8px] whitespace-nowrap">
                ORGULLOSAMENTE ATENDIENDO PUERTO RICO
              </div>
            </div>
          </div>
        </div>
      ...
      <main
        ...
        style={{
          backgroundImage: "url('/puerto rico immigration bgd-min.jpg')",
      ...
      >
        ...
        <div className="flex-1 md:ml-16 md:mr-8 flex flex-col justify-center mb-8 lg:mb-0">
          <div className="relative z-10 [text-shadow:0px_0px_6.9px_#00000066] [font-family:'Roboto',Helvetica] font-light text-white text-lg md:text-[23px] tracking-[-0.5px] md:tracking-[-1.00px] leading-[20px] md:leading-[25.3px] text-center lg:text-left mb-4 md:mb-[25px]">
            ABOGADA DE INMIGRACIÓN EN PUERTO RICO | CERCANA, BILINGÜE Y COMPROMETIDA CONTIGO
          </div>
          ...
          <p className="relative z-10 [text-shadow:0px_0px_6.9px_#00000066] [font-family:'Roboto',Helvetica] font-light text-[#cbd5e0] text-base md:text-lg lg:text-[20px] tracking-[0] leading-[24px] md:leading-[28px] mb-6 md:mb-[40px] max-w-[700px] text-center lg:text-left">
            En las Oficinas Legales de Ariadne Berrios, LLC, la abogada Ariadne Berrios entiende las historias, los retos y las esperanzas de nuestra gente. Desde su oficina en San Juan, Puerto Rico, ofrece asesoría migratoria clara, humana y completamente bilingüe, ayudando a familias, profesionales y empresarios a alcanzar sus metas legales en los Estados Unidos.
            <br /><br />
            Con oficinas en Área Metropolitana de Las Vegas y en San Juan, Puerto Rico, el despacho atiende con orgullo a clientes de todo el país con con la calidez de un servicio local y la experiencia de una firma nacional.
          </p>
