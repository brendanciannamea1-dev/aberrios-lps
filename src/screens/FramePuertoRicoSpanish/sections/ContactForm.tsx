  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        form_location: 'Puerto Rico - Spanish',
      };
      ...
      setTimeout(() => {
        window.location.href = '/lp-gracias';
      }, 1500);
    } catch (error) {
    ...
    <Card className="w-full max-w-md lg:max-w-none bg-black/90 border-[#b89158] border-2 backdrop-blur-sm">
      <CardHeader className="pb-4">
        ...
        <p className="text-[#cbd5e0] text-center text-xs md:text-sm [font-family:'Roboto',Helvetica] font-light">
          Reciba apoyo migratorio bilingüe
        </p>
        <p className="text-[#cbd5e0] text-center text-xs md:text-sm [font-family:'Roboto',Helvetica] font-light italic mt-2">
          La tarifa de consulta de $100 se acredita a su caso si contrata dentro de una semana de la cita.
        </p>
      </CardHeader>
      <CardContent>
        <form name="puerto-rico-immigration-form-spanish" onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
          <div>
            <input
              type="text"
              name="name"
          ...
          <div>
            <textarea
              name="message"
              placeholder="Breve descripción de su caso"
