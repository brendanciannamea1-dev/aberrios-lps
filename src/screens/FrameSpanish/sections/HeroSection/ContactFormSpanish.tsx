...
export const ContactFormSpanish = (): JSX.Element => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        form_location: 'Las Vegas - Spanish',
      };
  ...
  return (
    <Card className="w-full max-w-md lg:max-w-none bg-black/90 border-[#b89158] border-2 backdrop-blur-sm">
      ...
      <CardContent>
        <form name="las-vegas-immigration-lp-spanish" onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
          <div>
            <input
              type="text"
              name="name"
          ...
          {submitStatus === 'success' && (
            <div className="text-green-400 text-center text-sm [font-family:'Roboto',Helvetica]">
              ¡Gracias! Nos comunicaremos con usted dentro de 24 horas.
            </div>
          )}
